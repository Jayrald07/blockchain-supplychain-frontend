...
export default ({ question, description, buttons, onClose, handleClick }: { question: string, description: string, buttons: string[], onClose: () => void, handleClick: (response: string) => void }) => {
  ...
  return <div className="fixed z-20 top-0 left-0 w-full flex justify-center items-start prompt-container h-full py-5">
    <div className="bg-white w-3/4 sm:3/4 md:w-2/4 lg:w-1/4 rounded-sm shadow-md ">
