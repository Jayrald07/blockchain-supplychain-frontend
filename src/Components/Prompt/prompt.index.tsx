...
export default ({ question, description, buttons, onClose, handleClick }: { question: string, description: string, buttons: string[], onClose: () => void, handleClick: (response: string) => void }) => {
  ...
  return <div className="absolute top-0 left-0 w-full flex justify-center items-start prompt-container h-full py-5">
    <div className="bg-white w-3/12 rounded-sm shadow-md ">
